...
- **ranking**: パイプ区切り。企業名**最大10文字**、説明**最大20文字**（例: "トヨタ自動車|世界最大の自動車メーカー"）
- **company-card**: パイプ区切り。企業名**最大10文字**（例: "トヨタ自動車|850万円|500名|福利厚生充実"）
- **cover**: タイトルは**最大12文字**。contentの1行目はバナー**最大14文字**（例: "就活生必見！プロが教える"）
- **cta**: サブテキスト
